...
namespace Squalr.Theme.Controls
{
	...
	public class OverlayWindow : Window, IOverlayWindow
	{
		...
		internal void UpdateThemeResources(ThemeBase oldTheme = null)
		{
			...
			if (_host.Manager.ThemeBase != null) // Implicit parameter to this method is the new theme already set here
			{
				if (_host.Manager.ThemeBase is DictionaryTheme theme)
				{
				...
				{
					Resources.MergedDictionaries.Add(new ResourceDictionary() { Source = _host.Manager.ThemeBase.GetResourceUri() });
				}
			}
		}
